package com.casanube.scan.device;
...
import com.casanube.scan.util.LimitedLinkHashMap;
...
//        result = prime * result + ((mRecordStore == null) ? 0 : mRecordStore.hashCode());
    ...
    public String toString() {
        return "BluetoothLeDevice [mDevice=" + mDevice + ", mRssi=" + mFirstRssi + ", mScanRecord=" +", getBluetoothDeviceBondState()=" + getBluetoothDeviceBondState() + ", getBluetoothDeviceClassName()="  + "]";
    }
